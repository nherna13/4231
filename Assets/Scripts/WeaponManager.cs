...
public class WeaponManager : MonoBehaviour
{
    ...
    private void AddWeaponIntoActiveSlot(GameObject pickedupWeapon)
    {
        ...
        pickedupWeapon.transform.localRotation = Quaternion.Euler(weapon.spawnRotaion.x, weapon.spawnRotaion.y, weapon.spawnRotaion.z);
    ...
    private void PickupThrowableAsLethal(Throwable.ThrowableType lethal)
    {
        ...
        {
            // cannot pick up different lethals 
            //options to swap lethals
        }
    }
